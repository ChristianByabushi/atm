        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h2><?=  $_SESSION['user_connected']->first_name?></h2>
              <h3>Directeur</h3>
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab"
                    data-bs-target="#profile-overview">Details du Compte </button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?=  $_SESSION['user_connected']->first_name?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Entreprise</div>
                    <div class="col-lg-9 col-md-8">THUMAN</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Travail</div>
                    <div class="col-lg-9 col-md-8">Director</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Bagira QB</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">TEL</div>
                    <div class="col-lg-9 col-md-8">+2435663553</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8"><?=  $_SESSION['user_connected']->email?></div>
                  </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Entrer encore le nouveau</label>
                      <div class="col-md-8 col-lg-9">
